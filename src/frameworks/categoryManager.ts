...
let productsList = [
    new Product("img/img-food/Sapphire-Seafood-Symphony.webp", "Sapphire Seafood Symphony",
     "this dish features a colorful assortment of seafood, including blue-tinted scallops, enhanced with a twist of lemon and a garnish of fresh herbs", categories.ENTRADAS),
    new Product();
    new Product();
    new Product();
    new Product();
